...
- Advanced AI feedback and detailed analysis
- Extended question bank (1000+ questions)
- Priority support
- No ads or promotional content

### Coming Soon Features
- Sector-specific interview packs
- Document export (CV as DOCX)
...
- You may delete your account at any time via **Settings > Privacy & Security > Delete Account**
- Deletion is permanent and cannot be undone
- Refunds are subject to Section 6 (Subscriptions)
...
### You May:
- ✅ Use the App for personal interview preparation
- ✅ Share success stories (with your own experiences)
...
- ❌ Resell or redistribute AI feedback without permission
...
**Premium Annual**
- Price: £59.99/year (save 37% vs. monthly)
- Auto-renews annually
- Cancel anytime (effective next billing cycle)

### Payment Processing
- Payments processed via Apple App Store or Google Play Store
- Subscriptions managed through RevenueCat
- Prices include applicable VAT (UK) or sales tax
...
- You can cancel auto-renewal in your device's subscription settings

### Cancellation
- Cancel anytime via App Store/Play Store subscription settings
- No refund for unused time in current billing period
- Access continues until end of paid period

### Refund Policy
- **Within 48 hours of purchase**: Full refund, no questions asked (contact us directly)
- **After 48 hours**: No refunds for current billing period
- **Technical issues**: Refunds at our discretion if service was unusable
- **Chargebacks**: May result in account termination

### Free Trial (If Offered)
- Free trial period as advertised (e.g., 7 days)
- Cancel before trial ends to avoid charges
- One free trial per user (tracked by email and device)
...
- Any feedback you provide becomes our property
- We may use feedback to improve the App without compensation to you

## 8. AI-Generated Content

### AI Disclaimer
- Interview feedback is generated by AI (Groq/LLaMA models)
- AI suggestions are for educational purposes only
- Not a substitute for professional career advice

### Accuracy
- We strive for accuracy but do not guarantee perfection
- AI may occasionally produce incorrect or biased feedback
...
### Job Search (Adzuna)
- Job listings provided by Adzuna API
- We are not responsible for job posting accuracy or employer actions
- Apply to jobs at your own risk

### External Links
- The App may contain links to third-party websites
- We are not responsible for external content or privacy practices
- Review third-party terms and policies before engaging

## 10. Privacy and Data Protection

### Privacy Policy
- Your use of the App is also governed by our [Privacy Policy](https://myinterviewapp.com/privacy)
- We collect, use, and protect data as described in the Privacy Policy
...
### Exceptions
- We do not limit liability for death or personal injury caused by negligence
- We do not limit liability for fraud or fraudulent misrepresentation
- Other exclusions prohibited by UK law remain unaffected
...
- We may update these Terms to reflect legal or service changes
- Changes will be posted in the App and via email 30 days before effective date
- Continued use after effective date constitutes acceptance

### Disagreement with Changes
- If you disagree with updated Terms, delete your account before effective date
- No refund for unused subscription time upon voluntary account deletion
...
4. You have parental consent if under 18
5. You will use the App in accordance with these Terms
